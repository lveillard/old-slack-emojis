...
emojiStyle.innerText = ".emoji-outer, .emoji[style*='sheet_google_64_indexed_256.png']{ background-image: url('https://cdn.rawgit.com/stolksdorf/old-slack-emojis/74299ce5/blob_sprite_64.png') !important; }";
